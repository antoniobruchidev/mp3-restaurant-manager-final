...
/// @custom:security-contact antoniobruchidev@gmail.com
contract AccessManager is AccessControl {
    ...
    constructor(address defaultAdmin) {
        ...
        _grantRole(WAITER_ROLE, defaultAdmin);
        _setRoleAdmin(CHEF_ROLE, MANAGER_ROLE);
        _setRoleAdmin(WAITER_ROLE, MANAGER_ROLE);    
    }
